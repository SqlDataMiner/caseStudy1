...
# Question 2.3
The median is calculated as follows where $median_a$ and $median_b$ be the median survival times for treatments A and B respectively. the reader is reminded that age is not significant in the model so was not included.:
$$
\begin{aligned}
