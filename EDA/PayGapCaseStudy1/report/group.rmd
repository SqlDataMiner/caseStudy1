...
```
## Plot #3 Scatter graphs of percentage of females within quartile data
```{r scatter_graphs}
...
The plots show that females are over-represented in the lower and middle quartiles and under-represented in the top quartile.  There also appears to be possible differences between institutions which may be worth performing further analysis upon.
